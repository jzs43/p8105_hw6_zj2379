...
![](p8105_hw6_zj2379_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
```
    ...
    ##  3 1          34      63  3175   143      25 1        41.9 0             13
    ##  4 1          35      51  3345   145      75 1        41.3 0             12
    ##  5 2          35      52  3289   135      55 1        40.6 0             13
    ##  6 2          34      52  3629   112      25 1        38   0             10
    ##  7 1          35      55  3856   171      85 1        41.1 0             13
    ##  8 2          34      49  3317   142      35 1        40.4 0             12
    ##  9 2          34      49  2948   135      75 1        42.7 0             12
    ## 10 2          34      49  3033   128      25 1        41.1 0             12
    ## # ℹ 859 more rows
    ## # ℹ 12 more variables: mheight <dbl>, momage <dbl>, mrace <fct>, parity <fct>,
    ## #   pnumlbw <dbl>, pnumsga <dbl>, ppbmi <dbl>, ppwt <dbl>, smoken <dbl>,
    ## #   wtgain <dbl>, fitted_values <dbl>, residuals <dbl>
...
![](p8105_hw6_zj2379_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
